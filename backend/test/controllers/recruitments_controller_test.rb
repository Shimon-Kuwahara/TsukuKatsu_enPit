...
class RecruitmentsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create recruitment" do
    assert_difference("Recruitment.count") do
      post recruitments_url, params: { recruitment: { description: @recruitment.description, title: @recruitment.title } }
    end
  ...
  test "should update recruitment" do
    patch recruitment_url(@recruitment), params: { recruitment: { description: @recruitment.description, title: @recruitment.title } }
