...
ActiveRecord::Schema[7.0].define(version: 20_241_125_042_215) do
  ...
  create_table 'applications', force: :cascade do |t|
    ...
    t.index %w[user_id recruitment_id], name: 'index_applications_on_user_id_and_recruitment_id', unique: true
  ...
  create_table 'companies', force: :cascade do |t|
    ...
    t.index %w[uid provider], name: 'index_companies_on_uid_and_provider', unique: true
  end
